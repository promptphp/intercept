 ...
 * - pii: a proposed argument carries data matching a configured entity. Whether that signals
 *   exfiltration depends on the entity: a card number or an API key almost always does, while
 *   an email address in a mail tool is usually the function signature. The default entity list
