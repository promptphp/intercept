...
- detect emails, phone numbers, credit cards, IP addresses, MAC addresses, API keys, and bearer tokens
- block credit cards, API keys, and bearer tokens
- redact lower-risk values such as emails, phone numbers, MAC addresses and IP addresses
